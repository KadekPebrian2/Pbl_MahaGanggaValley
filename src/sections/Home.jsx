      ...
      <div className="container">
        <div className="home-inner">
          <div className="hero-left">
            <div className="eyebrow reveal" style={{ '--delay': '0.1s' }}>Discover • Relax • Remember</div>
            <h1 className="hero-title reveal" style={{ '--delay': '0.2s' }}>Maha Gangga Valley</h1>
          ...
          <aside className="hero-card reveal" aria-hidden="true" style={{ '--delay': '0.5s' }}>
