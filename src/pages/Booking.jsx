...
export default function Booking() {
  ...
  const handleSubmit = (e) => {
    ...
    // Pindah ke Halaman Payment membawa Data Pesanan
    navigate("/payment", {
      state: {
        bookingData: {
          ...formData, // Mengirim Nama, Email, Phone, Alamat, Tanggal
          qty: qty,
    ...
    <div className="booking-section">
      ...
      <div className="booking-left">
        ...
        <div className="header-simple">
          {/* Judul dengan Style Khusus (Inline agar aman sesuai request) */}
        ...
        <form onSubmit={handleSubmit} className="booking-form">
          ...
          {/* Tanggal & Jumlah Tiket (Berdampingan) */}
