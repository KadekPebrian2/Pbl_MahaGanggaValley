    ...
    <section id="map" className="map-section">
      <div className="container">
        ...
        <div className="map-frame reveal" style={{ '--delay': '0.2s' }}>
          ...
          {/* <iframe> adalah tag HTML untuk menanam konten dari web lain.
            Di sini kita menanam Google Maps.
          */}
          <iframe
            ...
            // Browser tidak akan mengunduh peta ini sampai pengguna
            // scroll mendekati bagian peta. Menghemat data & mempercepat load awal.
            loading="lazy"
